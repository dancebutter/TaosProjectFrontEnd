...
*
* geArgus GST modified to allow for mime type specify (for LESS files)
*
*/

var boolGlobalAngularCssInjectorModifiedbyGe = true;	// flag for app to make sure that this version is loaded and not a newer non-ge version from the web
...
.provider('cssInjector', function() {
	...
	function CssInjector($compile, $rootScope){
        ...
        // geArgus: GST added optional rel parm
		var addStylesheet = function ( href, rel )
        {
            _initScope();
            ...
            if(scope.injectedStylesheets === undefined)
            {
				...
				var strLine = "<link data-ng-repeat='stylesheet in injectedStylesheets' data-ng-href='{{stylesheet.href}}' rel='{{stylesheet.rel}}' />";

				head.append ( $compile ( strLine )( scope )); // Found here : http://stackoverflow.com/a/11913182/1662766
            ...
            scope.injectedStylesheets.push ( { href: href, rel: rel } );
        };
